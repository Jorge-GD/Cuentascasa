...
export function PreviewTable({ 
  ...
  const duplicados = movimientos.filter(m => m.confianza < 50)
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        {duplicados.length > 0 && (
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="text-sm font-medium text-red-800">Posibles Duplicados</div>
            <div className="text-2xl font-bold text-red-900">{duplicados.length}</div>
          </div>
        )}
      </div>
      ...
      {duplicados.length > 0 && (
        <Alert>
          ...
          <AlertDescription>
            Se encontraron {duplicados.length} movimientos con confianza muy baja que podrían ser duplicados.
            Revisa estos movimientos antes de importar.
          </AlertDescription>
        </Alert>
      )}
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <CategorizationEditor
                        ...
                        onSave={(updates) => {
                          handleMovimientoUpdate(index, updates)
                          setEditingMovimiento(null)
                        }}
                        onCancel={() => setEditingMovimiento(null)}
                      />
                    </DialogContent>
                  </Dialog>
                </TableCell>
